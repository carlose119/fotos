...
<div class="grid_6 preffix_1">
    ...
    <label class="name">
        <?= $this->Form->control('nombre', ['label' => false, 'type' => 'text', 'placeholder' => 'Nombre', 'required' => true, 'data-constraints' => "@Required @JustLetters"]) ?>
    ...
    <label class="phone">
        <?= $this->Form->control('telefono', ['label' => false,'type' => 'number', 'placeholder' => 'Telefono', 'required' => true, 'data-constraints' => "@Required @JustNumbers"]) ?>
        <span class="empty-message">*El campo no puede esta vacio.</span>
        <span class="error-message">*This is not a valid phone.</span>
    </label>
    <label class="message">
        <?= $this->Form->control('mensaje', ['label' => false, 'type' => 'textarea', 'placeholder' => 'Mensaje', 'required' => true, 'data-constraints' => "@Required @Length(min=20,max=999999)"]) ?>
        <span class="empty-message">*El campo no puede esta vacio.</span>
    ...
    <div>
        <div class="clear"></div>
        <div class="btns">
            <?= $this->Form->button('Enviar', ['data-type' => "submit", 'class' => "btn bt__2"]) ?>
        </div>
    </div>
    <?= $this->Form->end() ?>
</div>
